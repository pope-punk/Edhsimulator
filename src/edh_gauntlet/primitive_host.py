...
in the pool. Bundles accept mana abilities and their mana-color choices only.
Automatic payment includes supported paid filters, life payments, creature mana, sacrifice, discard, exile and counter costs. Prefer ordinary sources; legal lethal payments are allowed when needed.
...
Explicit mana activation is for a deliberate float or an exact source choice, not the normal pathway to casting. Use manual payment only when necessary
