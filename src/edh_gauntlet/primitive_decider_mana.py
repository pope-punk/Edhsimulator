...
def presentation(value):
    ...
    value['payment_policy']='Choose the spell or non-mana ability without mana instructions. Python pays automatically. Accept planner mana sequencing by approving its unchanged step IDs. Pay an optional mana request with pay_mana and request_id only, or decline with payment:null.'
    return value
...
Python selects and pays mana automatically. Do not submit autotap, reservations,
