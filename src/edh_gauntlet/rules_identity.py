...
_MODULES = (
    ...
    'rules_kernel.py', 'rules_resolution_cast.py','rules_spell_copy.py', 'rules_copy.py', 'rules_mana.py', 'rules_guard.py', 'rules_phasing.py', 'rules_counters.py', 'rules_actor.py', 'rules_adapter.py', 'rules_durable.py', 'rules_departure.py', 'rules_library.py', 'rules_attachments.py', 'rules_replacements.py',
