...
- Compatibility only: [legacy contracts](LEGACY_CONTRACTS.md), [desktop pilot dispatch](PILOT_RUNTIME_POLICY.md), [legacy split dispatch](SPLIT_RUNTIME_POLICY.md).

Current split software-host rules supersede older single-planner and desktop
coordinator examples. Started games always retain their bound contracts.
